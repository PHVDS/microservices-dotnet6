	...
	public class DbInitializer : IDbInitializer
	{
		...
		{ 
			...
			ApplicationUser admin = new ApplicationUser()
			{
				...
				Email = "paulo-admin@gmail.com",
				EmailConfirmed = true,
				PhoneNumber = "+55 (79) 99822-7780",
				FirstName = "Paulo",
				LastName = "Admin"
			};

			_user.CreateAsync(admin, "#01Ph1191").GetAwaiter().GetResult();
			...
			_user.CreateAsync(client, "#01Ph1191").GetAwaiter().GetResult();
