...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public CartRepository(ICartRepository cartRepository, MySQLContext context, IMapper mapper)
        {
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO vo)
        {
            ...
            //Checks if the product is already save in the database, if it does not exit then save.
            ...
            {
                //If CartHeader is not null and check if CartDetails has same product
